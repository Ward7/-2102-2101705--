...
public:
    ...
    virtual XTensor Make_int8(XTensor& input, XTensor* mask, XTensor& mask2, bool isTraining) = 0;
};
...
public:
    ...
    XTensor Make_int8(XTensor& input, XTensor* mask, bool isTraining);
    XTensor Make_int8(XTensor& input, XTensor* mask, XTensor& maskEncDec, bool isTraining);
};
